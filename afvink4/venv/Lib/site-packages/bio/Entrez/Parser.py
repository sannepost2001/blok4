    ...
    def read(self, handle):
        ...
        try:
            ...
            if self.parser.StartElementHandler:
                ...
                # a bug.
                raise RuntimeError(
                    "Failed to parse the XML file correctly, possibly due to a bug in Bio.Entrez. Please contact the Biopython developers via the mailing list or GitHub for assistance.")
            else:
    ...
    def parse(self, handle):
        ...
        while True:
            ...
            if not isinstance(records, list):
                raise ValueError(
                    "The XML file does not represent a list. Please use Entrez.read instead of Entrez.parse")
